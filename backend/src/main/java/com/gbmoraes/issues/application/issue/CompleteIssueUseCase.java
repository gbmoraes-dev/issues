...
public class CompleteIssueUseCase {

  private final IssueRepository issueRepository;

  public CompleteIssueUseCase(IssueRepository issueRepository) {
  ...
  public IssueOutput execute(String id, String userId) {
    ...
    Issue completed = issue.toggle();

    return IssueOutput.fromDomain(issueRepository.save(completed));
  }
}
